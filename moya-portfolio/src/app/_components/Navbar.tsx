    ...
    return (
        <>
            ...
            <nav
                ...
                className={classNames(
                    "sm:block hidden w-[30rem] mx-auto text-custom-content-2/85 sticky top-2 z-50 px-2 transition-all duration-500 ease-in-out animate-fade-in-top animation-delay-300"
